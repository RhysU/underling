...
Builds and tests underling across the Ubuntu image matrix. Installs MPI, FFTW
(with MPI support), and Boost from system packages, then runs the full
autotools build: `bootstrap`, `configure`, `make`, `make check`.
...
3. Your documentation will be available at:
   `https://<username>.github.io/underling/`
